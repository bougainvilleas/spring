...
| springboot-hottask-starter |springboot| java |
|:---------------------------|:---|:-----|
| 0.0.3                      |2.6.4| 1.8  |
...
2. gradle 引入 `implementation 'org.bougainvilleas.spring:springboot-hottask-starter:0.0.3'`

### 直接导入本地jar包
1. gradle build ***springboot-hottask-starter-0.0.3-plain.jar***
