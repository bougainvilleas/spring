...
import org.bougainvillea.spring.entity.RedisZsetData;
 ...
 */
@Component
public class RedisZSetExecutor extends RedisExecutor {

    @Autowired
    public RedisZSetExecutor(RedisTemplate<String, Object> redisTemplate, StringRedisTemplate stringRedisTemplate) {
    ...
    public <V extends RedisOperateData> RedisResultData writeRequest(V data) {
        if(data instanceof RedisZsetData){
            // do something
            return null;
        }
